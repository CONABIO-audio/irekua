# Generated by Django 2.1.7 on 2019-06-13 02:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='annotation', default=database.utils.empty_JSON, help_text='Information of annotation location within item', verbose_name='annotation')),
                ('annotation_configuration', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='annotation_configuration', default=database.utils.empty_JSON, help_text='Configuration of annotation tool', verbose_name='annotation configuration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuration_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='configuration_schema', default=database.utils.simple_JSON_schema, help_text='JSON schema for annotation tool configuration info', validators=[database.utils.validate_JSON_schema], verbose_name='configuration schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('name', models.CharField(db_column='name', help_text='Name for type of annotation', max_length=64, primary_key=True, serialize=False, verbose_name='name')),
                ('description', models.TextField(db_column='description', help_text='Description of annotation type', verbose_name='description')),
                ('annotation_schema', django.contrib.postgres.fields.jsonb.JSONField(db_column='annotation_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for annotation info', validators=[database.utils.validate_JSON_schema], verbose_name='annotation schema')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation', models.ForeignKey(db_column='annotation_id', help_text='Reference to annotation being voted', on_delete=django.db.models.deletion.CASCADE, to='database.Annotation', verbose_name='annotation')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='annotationvote_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('name', models.CharField(db_column='name', help_text='Name of collection', max_length=128, primary_key=True, serialize=False, verbose_name='name')),
                ('description', models.TextField(db_column='description', help_text='Description of collection', verbose_name='description')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', default=database.utils.empty_JSON, help_text='Metadata associated to collection', verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection to which the device belongs', on_delete=django.db.models.deletion.CASCADE, to='database.Collection', verbose_name='collection')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collectiondevice_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of collection device info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of collection item info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of collection role info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', default=database.utils.empty_JSON, help_text='Metadata associated to site in collection', null=True, verbose_name='metadata')),
                ...
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection to which the site belongs', on_delete=django.db.models.deletion.CASCADE, to='database.Collection', verbose_name='collection')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collectionsite_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of collection info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
                ...
                ('annotation_types', models.ManyToManyField(blank=True, help_text='Types of annotations valid for collections of type', to='database.AnnotationType', verbose_name='annotation types')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection to which user belongs', on_delete=django.db.models.deletion.CASCADE, to='database.Collection', verbose_name='collection')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collectionuser_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of device info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
                ('configuration_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='configuration_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for configuration info of device', validators=[database.utils.validate_JSON_schema], verbose_name='configuration schema')),
            ],
            options={
                'verbose_name': 'Device',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of entailment info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='institution_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_file', models.FileField(blank=True, db_column='item_file', help_text='Upload file associated to file', null=True, upload_to=database.models.items.items.get_item_path, verbose_name='item file')),
                ('media_info', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='media_info', default=database.utils.empty_JSON, help_text='Information of resource file', verbose_name='media info')),
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='item_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
            ],
            options={
                'verbose_name': 'Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_types', models.ManyToManyField(blank=True, db_column='event_types', help_text='Types of event for this item type', to='database.EventType', verbose_name='event types')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection to which this licence belongs', on_delete=django.db.models.deletion.CASCADE, to='database.Collection', verbose_name='collection')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='licence_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of licence info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
        ...
        migrations.CreateModel(
            name='MetaCollection',
            fields=[
                ('name', models.CharField(db_column='name', help_text='Name of meta collection', max_length=64, primary_key=True, serialize=False, verbose_name='name')),
                ('description', models.TextField(db_column='description', help_text='Description of Meta Collection', verbose_name='description')),
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('created_by', models.ForeignKey(blank=True, db_column='created_by', help_text='Creator of Meta Collection', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='metacollection_created_by', to=settings.AUTH_USER_MODEL, verbose_name='created by')),
                ...
                ('items', models.ManyToManyField(blank=True, help_text='Items belonging to MetaCollection', to='database.Item', verbose_name='items')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='physicaldevice_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
                ('device', models.ForeignKey(db_column='device_id', help_text='Reference to type of device', on_delete=django.db.models.deletion.PROTECT, to='database.Device', verbose_name='device')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('name', models.CharField(db_column='name', help_text='Name of role', max_length=64, primary_key=True, serialize=False, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection to which sampling event belongs', on_delete=django.db.models.deletion.PROTECT, to='database.Collection', verbose_name='collection')),
                ('collection_site', models.ForeignKey(blank=True, db_column='collection_site_id', help_text='Reference to site at which sampling took place', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.CollectionSite', verbose_name='collection site')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='samplingevent_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
                ('licence', models.ForeignKey(blank=True, db_column='licence_id', help_text='Licence for all items in sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Licence', verbose_name='licence')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('commentaries', models.TextField(blank=True, db_column='commentaries', help_text='Sampling event commentaries', verbose_name='commentaries')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', default=database.utils.empty_JSON, help_text='Metadata associated to sampling event device', null=True, verbose_name='metadata')),
                ...
                ('collection_device', models.ForeignKey(blank=True, db_column='collection_device_id', help_text='Reference to collection device used on sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.CollectionDevice', verbose_name='collection device')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='samplingeventdevice_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
                ('licence', models.ForeignKey(blank=True, db_column='licence_id', help_text='Licence for all items in sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Licence', verbose_name='licence')),
                ...
                ('sampling_event', models.ForeignKey(db_column='sampling_event_id', help_text='Sampling event in which this device was deployed', on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEvent', verbose_name='sampling event')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of sampling event info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON schema for metadata associated to device in sampling event', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
                ('device_type', models.ForeignKey(db_column='device_type_id', help_text='Type of device that can be used in sampling event of the given type', on_delete=django.db.models.deletion.PROTECT, to='database.DeviceType', verbose_name='device type')),
                ('sampling_event_type', models.ForeignKey(db_column='sampling_event_type_id', help_text='Sampling event type in which this device types can be placed', on_delete=django.db.models.deletion.CASCADE, to='database.SamplingEventType', verbose_name='sampling event type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_file', models.FileField(blank=True, db_column='item_file', help_text='Upload file associated to file', null=True, upload_to=database.models.items.secondary_items.get_item_path, verbose_name='item file')),
                ...
                ('item', models.ForeignKey(db_column='item_id', help_text='Reference to primary item associated to secondary item', on_delete=django.db.models.deletion.CASCADE, to='database.Item', verbose_name='item id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('name', models.CharField(blank=True, db_column='name', help_text='Name of site', max_length=128, null=True, verbose_name='name')),
                ('locality', models.CharField(blank=True, db_column='locality', help_text='Name of locality in which the site is located', max_length=256, verbose_name='locality')),
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='site_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of site info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='synonymsuggestion_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('name', models.CharField(db_column='name', help_text='Name of tag', max_length=128, primary_key=True, serialize=False, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, db_column='description', help_text='Description of term', verbose_name='description')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', default=database.utils.empty_JSON, help_text='Metadata associated to term', null=True, verbose_name='metadata')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='termsuggestion_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of term info', validators=[database.utils.validate_JSON_schema], verbose_name='metadata schema')),
                ('synonym_metadata_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='synonym_metadata_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of synonym info', validators=[database.utils.validate_JSON_schema], verbose_name='synonym metadata schema')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='term_type',
            field=models.ForeignKey(db_column='term_type', help_text='Type of term', on_delete=django.db.models.deletion.CASCADE, to='database.TermType', verbose_name='term type'),
        ),
        migrations.AddField(
            model_name='term',
            name='term_type',
        ...
        migrations.AddField(
            ...
            name='device_types',
            field=models.ManyToManyField(blank=True, help_text='Valid device types for this sampling event type', through='database.SamplingEventTypeDeviceType', to='database.DeviceType', verbose_name='device types'),
        ),
        migrations.AddField(
            model_name='samplingeventtype',
            name='site_types',
            field=models.ManyToManyField(blank=True, help_text='Valid site types for this sampling event type', to='database.SiteType', verbose_name='site types'),
        ),
        migrations.AddField(
            model_name='samplingevent',
            name='sampling_event_type',
            field=models.ForeignKey(db_column='sampling_event_type', help_text='Type of sampling event', on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEventType', verbose_name='sampling event type'),
        ),
        migrations.AddField(
            model_name='licence',
            name='licence_type',
            field=models.ForeignKey(db_column='licence_type_id', help_text='Type of licence used', on_delete=django.db.models.deletion.PROTECT, to='database.LicenceType', verbose_name='licence type'),
        ),
        migrations.AddField(
            model_name='licence',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='item',
            name='item_type',
            field=models.ForeignKey(db_column='item_type_id', help_text='Type of resource', on_delete=django.db.models.deletion.PROTECT, to='database.ItemType', verbose_name='item type'),
        ),
        migrations.AddField(
            model_name='item',
            name='licence',
            field=models.ForeignKey(blank=True, db_column='licence_id', help_text='Licence of item', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Licence', verbose_name='licence'),
        ),
        migrations.AddField(
            model_name='item',
            name='modified_by',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='sampling_event_device_id', help_text='Sampling event device used to create item', on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEventDevice', verbose_name='sampling event device'),
        ),
        migrations.AddField(
            model_name='item',
            name='source',
            field=models.ForeignKey(blank=True, db_column='source_id', help_text='Source of item (parsing function and parent directory)', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Source', verbose_name='source'),
        ),
        migrations.AddField(
            model_name='item',
            name='tags',
            field=models.ManyToManyField(blank=True, help_text='Tags for item', to='database.Tag', verbose_name='tags'),
        ),
        migrations.AddField(
            model_name='eventtype',
            name='term_types',
            field=models.ManyToManyField(blank=True, db_column='term_types', help_text='Valid term types with which to label this type of events', to='database.TermType', verbose_name='term types'),
        ),
        migrations.AddField(
            model_name='entailmenttype',
            name='source_type',
            field=models.ForeignKey(db_column='source_type_id', help_text='Term type of source of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_source_type', to='database.TermType', verbose_name='source type'),
        ),
        migrations.AddField(
            model_name='entailmenttype',
            name='target_type',
            field=models.ForeignKey(db_column='target_type_id', help_text='Term type of target of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_target_type', to='database.TermType', verbose_name='target type'),
        ),
        migrations.AddField(
            model_name='entailment',
            name='source',
            field=models.ForeignKey(db_column='source_id', help_text='Source of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_source', to='database.Term', verbose_name='source'),
        ),
        migrations.AddField(
            model_name='entailment',
            name='target',
            field=models.ForeignKey(db_column='target_id', help_text='Target of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_target', to='database.Term', verbose_name='target'),
        ),
        migrations.AddField(
            model_name='device',
            name='brand',
            field=models.ForeignKey(db_column='device_brand_id', help_text='Brand of device', on_delete=django.db.models.deletion.PROTECT, related_name='device_brand', to='database.DeviceBrand', verbose_name='brand'),
        ),
        migrations.AddField(
            model_name='device',
            name='device_type',
            field=models.ForeignKey(db_column='device_type_id', help_text='Type of device', on_delete=django.db.models.deletion.PROTECT, related_name='device_type', to='database.DeviceType', verbose_name='device type'),
        ),
        migrations.AddField(
            model_name='collectionuser',
            name='role',
            field=models.ForeignKey(db_column='role_id', help_text='Role of user in collection', on_delete=django.db.models.deletion.PROTECT, to='database.Role', verbose_name='role'),
        ),
        migrations.AddField(
            model_name='collectionuser',
            name='user',
            field=models.ForeignKey(db_column='user_id', help_text='User of collection', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='device_types',
            field=models.ManyToManyField(blank=True, help_text='Types of devices valid for collections of type', through='database.CollectionDeviceType', to='database.DeviceType', verbose_name='device types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='event_types',
            field=models.ManyToManyField(blank=True, help_text='Types of events valid for collections of type', to='database.EventType', verbose_name='event types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='item_types',
            field=models.ManyToManyField(blank=True, help_text='Types of items valid for collections of type', through='database.CollectionItemType', to='database.ItemType', verbose_name='item types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='licence_types',
            field=models.ManyToManyField(blank=True, help_text='Types of licences valid for collections of type', to='database.LicenceType', verbose_name='licence types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='roles',
            field=models.ManyToManyField(blank=True, help_text='Roles valid for collections of type', through='database.CollectionRole', to='database.Role', verbose_name='roles'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='sampling_event_types',
            field=models.ManyToManyField(blank=True, help_text='Types of sampling events valid for collections of type', to='database.SamplingEventType', verbose_name='sampling event types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='site_types',
            field=models.ManyToManyField(blank=True, help_text='Types of sites valid for collections of type', to='database.SiteType', verbose_name='site types'),
        ),
        migrations.AddField(
            model_name='collectionsite',
            name='site',
            field=models.ForeignKey(db_column='site_id', help_text='Reference to Site', on_delete=django.db.models.deletion.PROTECT, to='database.Site', verbose_name='site'),
        ),
        migrations.AddField(
            model_name='collectionsite',
            name='site_type',
            field=models.ForeignKey(db_column='site_type', help_text='Type of site', on_delete=django.db.models.deletion.PROTECT, to='database.SiteType', verbose_name='site type'),
        ),
        migrations.AddField(
            model_name='collectionrole',
            name='collection_type',
            field=models.ForeignKey(db_column='collection_type_id', help_text='Collection type in which role applies', on_delete=django.db.models.deletion.CASCADE, to='database.CollectionType', verbose_name='collection type'),
        ),
        migrations.AddField(
            model_name='collectionrole',
            name='role',
            field=models.ForeignKey(db_column='role_id', help_text='Role to be part of collection', on_delete=django.db.models.deletion.PROTECT, to='database.Role', verbose_name='role'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectionitemtype',
            name='item_type',
            field=models.ForeignKey(db_column='item_type_id', help_text='Item to be part of collection', on_delete=django.db.models.deletion.PROTECT, to='database.ItemType', verbose_name='item type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectiondevicetype',
            name='device_type',
            field=models.ForeignKey(db_column='device_type_id', help_text='Device to be part of collection', on_delete=django.db.models.deletion.PROTECT, to='database.DeviceType', verbose_name='device type'),
        ),
        migrations.AddField(
            model_name='collectiondevice',
            name='physical_device',
            field=models.ForeignKey(db_column='physical_device_id', help_text='Reference to physical device', on_delete=django.db.models.deletion.PROTECT, to='database.PhysicalDevice', verbose_name='physical device'),
        ),
        migrations.AddField(
            model_name='collection',
            name='collection_type',
            field=models.ForeignKey(db_column='collection_type_id', help_text='Type of collection', on_delete=django.db.models.deletion.PROTECT, to='database.CollectionType', verbose_name='collection type'),
        ),
        migrations.AddField(
            model_name='collection',
            name='created_by',
            field=models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collection_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator'),
        ),
        migrations.AddField(
            model_name='collection',
            name='institution',
            field=models.ForeignKey(blank=True, db_column='institution_id', help_text='Institution to which the collection belogs', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Institution', verbose_name='institution'),
        ),
        migrations.AddField(
            model_name='collection',
            name='modified_by',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, through='database.CollectionDevice', to='database.PhysicalDevice'),
        ),
        migrations.AddField(
            model_name='collection',
            name='sites',
            field=models.ManyToManyField(blank=True, through='database.CollectionSite', to='database.Site'),
        ),
        migrations.AddField(
            model_name='collection',
            name='users',
            field=models.ManyToManyField(blank=True, related_name='collection_users', through='database.CollectionUser', to=settings.AUTH_USER_MODEL),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='annotation_tool_id', help_text='Annotation tool used', on_delete=django.db.models.deletion.PROTECT, to='database.AnnotationTool', verbose_name='annotation tool'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='annotation_type',
            field=models.ForeignKey(db_column='annotation_type_id', help_text='Type of annotation', on_delete=django.db.models.deletion.PROTECT, to='database.AnnotationType', verbose_name='annotation type'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='created_by',
            field=models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='annotation_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='event_type',
            field=models.ForeignKey(db_column='event_type_id', help_text='Type of event being annotated', on_delete=django.db.models.deletion.PROTECT, to='database.EventType', verbose_name='event type'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='item',
            field=models.ForeignKey(db_column='item_id', help_text='Annotated item', on_delete=django.db.models.deletion.PROTECT, to='database.Item', verbose_name='item'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='user',
            name='institution',
            field=models.ForeignKey(blank=True, db_column='institution_id', help_text='Institution to which user belongs', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Institution', verbose_name='institution'),
        ),
        migrations.AddField(
            model_name='user',
