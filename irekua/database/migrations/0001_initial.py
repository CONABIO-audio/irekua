    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('physical_device', models.ForeignKey(blank=True, db_column='physical_device_id', help_text='Reference to physical device used on sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.PhysicalDevice', verbose_name='physical device')),
        ...
        migrations.AddField(
            model_name='samplingevent',
            name='site',
            field=models.ForeignKey(blank=True, db_column='site_id', help_text='Reference to site at which sampling took place', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Site', verbose_name='site'),
        ),
        migrations.AddField(
            model_name='licence',
            name='licence_type',
