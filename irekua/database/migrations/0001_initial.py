...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection in which licence is valid', on_delete=django.db.models.deletion.CASCADE, to='database.Collection', verbose_name='collection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filesize', models.IntegerField(db_column='filesize', editable=False, help_text='Size of resource in Bytes', verbose_name='file size')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(blank=True, db_column='device_id', help_text='Reference to device used on sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.PhysicalDevice', verbose_name='device id')),
        ...
        migrations.AddField(
            model_name='item',
            name='licence',
            field=models.ForeignKey(db_column='licence_id', help_text='Licence of item', on_delete=django.db.models.deletion.PROTECT, to='database.Licence', verbose_name='licence'),
        ),
        migrations.AddField(
            model_name='item',
            name='owner',
            field=models.ForeignKey(db_column='owner_id', help_text='Owner of item', on_delete=django.db.models.deletion.PROTECT, related_name='owner', to=settings.AUTH_USER_MODEL, verbose_name='owner'),
        ),
        migrations.AddField(
            model_name='item',
        ...
        migrations.AddField(
            ...
            name='licence',
            field=models.ForeignKey(db_column='licence_id', help_text='Licence which forms part of collection', on_delete=django.db.models.deletion.PROTECT, to='database.Licence', verbose_name='licence'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collection',
            name='licences',
            field=models.ManyToManyField(blank=True, help_text='Signed licences for items in this collection', through='database.CollectionLicence', to='database.Licence', verbose_name='licences'),
        ),
        migrations.AddField(
            model_name='collection',
            name='sites',
