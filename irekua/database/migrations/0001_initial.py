    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'permissions': (('add_collection_site', 'Can add site to collection'), ('add_collection_item', 'Can add item to collection'), ('add_collection_device', 'Can add device to collection'), ('add_collection_user', 'Can add user to collection'), ('add_collection_licence', 'Can add licence to collection')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution', models.ForeignKey(blank=True, db_column='institution_id', help_text='Institution to which user belongs', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Institution', verbose_name='institution')),
                ('user', models.OneToOneField(db_column='user_id', help_text='Reference to user', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
