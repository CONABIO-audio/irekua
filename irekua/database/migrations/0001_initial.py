# Generated by Django 2.1.7 on 2019-02-28 21:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Annotation type icon', null=True, upload_to='', verbose_name='icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Collection metadata', null=True, verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to user in collection', null=True, verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, db_column='logo', help_text='Logo of device brand', null=True, upload_to='', verbose_name='logo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Icon for device type', null=True, upload_to='', verbose_name='icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Event type icon', null=True, upload_to='', verbose_name='icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, db_column='logo', help_text='Institution logo', null=True, upload_to='', verbose_name='logo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Item type icon', null=True, upload_to='', verbose_name='icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Licence type icon', null=True, upload_to='', verbose_name='icon')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Role type icon', null=True, upload_to='', verbose_name='icon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('configuration', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='configuration', help_text='Configuration on device through the sampling event', null=True, verbose_name='configuration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_info', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='media_info', help_text='Media information of secondary item file', null=True, verbose_name='media info')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, db_column='icon', help_text='Term type icon', null=True, upload_to='', verbose_name='icon')),
                ('metadata_type', models.ForeignKey(db_column='metadata_type', default='free', help_text='Metadata for terms of type', limit_choices_to=models.Q(('field__exact', 'term_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='device',
            name='brand',
            field=models.ForeignKey(db_column='brand', help_text='Brand of device', limit_choices_to={'term_type': 'brand'}, on_delete=django.db.models.deletion.PROTECT, related_name='device_brand', to='database.DeviceBrand', verbose_name='brand'),
        ),
        migrations.AddField(
            model_name='device',
            name='device_type',
            field=models.ForeignKey(db_column='device_type', help_text='Type of device', limit_choices_to={'term_type': 'device_type'}, on_delete=django.db.models.deletion.PROTECT, related_name='device_type', to='database.DeviceType', verbose_name='device type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='annotation',
            name='metadata_type',
            field=models.ForeignKey(blank=True, db_column='metadata_type', default='free', help_text='JSON schema for metadata', limit_choices_to=models.Q(('field__exact', 'annotation_metadata'), ('field__exact', 'global'), _connector='OR'), null=True, on_delete=django.db.models.deletion.PROTECT, related_name='annotation_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AlterUniqueTogether(
            name='device',
