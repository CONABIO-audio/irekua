    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(db_column='role_type_id', help_text='Role of user in collection', on_delete=django.db.models.deletion.PROTECT, to='database.CollectionRoleType', verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', models.ForeignKey(db_column='metadata_type', default='free', help_text='Metadata for terms of type', limit_choices_to=models.Q(('field__exact', 'term_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='term_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata type')),
                ('synonym_metadata_schema', models.ForeignKey(db_column='synonym_metadata_type', default='free', help_text='Metadata for synonym of terms of type', limit_choices_to=models.Q(('field__exact', 'synonym_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='term_synonym_metadata_type', to='database.Schema', to_field='name', verbose_name='synonym metadata type')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='item',
            name='owner',
            field=models.ForeignKey(blank=True, db_column='owner_id', help_text='Owner of item', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='owner', to=settings.AUTH_USER_MODEL, verbose_name='owner'),
        ),
        migrations.AddField(
            model_name='item',
            name='sampling_event',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='configuration_type', default='free', help_text='JSON schema for device configuration', limit_choices_to=models.Q(('field__exact', 'device_configuration'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='device_configuration_type', to='database.Schema', to_field='name', verbose_name='configuration type'),
        ),
        migrations.AddField(
            model_name='device',
            name='device_type',
        ...
        migrations.AddField(
            model_name='collectiontype',
            name='role_types',
            field=models.ManyToManyField(blank=True, db_column='role_types', help_text='Types of roles valid for collections of type', through='database.CollectionRoleType', to='database.RoleType', verbose_name='role types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
        ...
        migrations.AddField(
            model_name='collectionroletype',
            name='role_type',
            field=models.ForeignKey(db_column='role_type_id', help_text='Role to be part of collection', on_delete=django.db.models.deletion.PROTECT, to='database.RoleType', verbose_name='role type'),
        ),
        migrations.AddField(
