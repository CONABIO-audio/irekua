...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', django.contrib.postgres.fields.jsonb.JSONField(db_column='label', help_text='Labels associated to annotation vote', verbose_name='label')),
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation of annotation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coordinator', models.ForeignKey(blank=True, db_column='coordinator_id', help_text='Collection coordinator', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='collection_coordinator', to=settings.AUTH_USER_MODEL, verbose_name='coordinator id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated with device within collection', null=True, verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection in which schema applies', on_delete=django.db.models.deletion.CASCADE, to='database.Collection', verbose_name='collection id')),
            ],
            options={
                'verbose_name': 'Collection Schema',
                'verbose_name_plural': 'Collection Schemas',
            },
        ),
        migrations.CreateModel(
            name='CollectionSite',
            fields=[
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated with site within collection', null=True, verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(db_column='metadata', help_text='Metadata associated to user in collection', verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('term_type', models.CharField(choices=[('device_type', 'device type'), ('brand', 'brand')], db_column='term_type', help_text='Type of term', max_length=16, verbose_name='term type')),
                ('value', models.CharField(db_column='value', help_text='Admissible value for type of term', max_length=128, verbose_name='value')),
                ('added_by', models.ForeignKey(blank=True, db_column='added_by', help_text='User that uploaded this term', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='added by')),
            ],
            options={
                'verbose_name': 'Device Term',
                'verbose_name_plural': 'Device Terms',
            },
        ),
        migrations.CreateModel(
            name='Entailment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_info', django.contrib.postgres.fields.jsonb.JSONField(db_column='media_info', help_text='Information of resource file', verbose_name='media info')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to item', null=True, verbose_name='metadata')),
        ...
        migrations.CreateModel(
            name='ItemType',
            fields=[
                ('name', models.CharField(db_column='name', help_text='Name of item type', max_length=50, primary_key=True, serialize=False, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated with licence', null=True, verbose_name='metadata')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collections', models.ManyToManyField(to='database.Collection')),
        ...
        migrations.CreateModel(
            name='RoleType',
            fields=[
                ('name', models.CharField(db_column='name', help_text='Name of role', max_length=16, primary_key=True, serialize=False, verbose_name='name')),
                ('description', models.TextField(blank=True, db_column='description', help_text='Description of role', verbose_name='description')),
                ('can_add_items', models.BooleanField(db_column='can_add_items', help_text='Can add items to collection', verbose_name='can add items')),
                ('can_view_items', models.BooleanField(db_column='can_view_items', help_text='Can view items in collection', verbose_name='can view items')),
                ('can_update_items', models.BooleanField(db_column='can_update_items', help_text='Can update items in collection', verbose_name='can update items')),
                ('can_download_items', models.BooleanField(db_column='can_download_items', help_text='Can download items in collection', verbose_name='can download items')),
                ('can_add_sites', models.BooleanField(db_column='can_add_sites', help_text='Can add sites to collection', verbose_name='can add sites')),
                ('can_view_sites', models.BooleanField(db_column='can_view_sites', help_text='Can view sites in collection', verbose_name='can view sites')),
                ('can_update_sites', models.BooleanField(db_column='can_update_sites', help_text='Can update sites in collection', verbose_name='can update sites')),
                ('can_remove_sites', models.BooleanField(db_column='can_remove_sites', help_text='Can remove sites from collection', verbose_name='can remove sites')),
                ('can_add_devices', models.BooleanField(db_column='can_add_devices', help_text='Can add devices to collection', verbose_name='can add devices')),
                ('can_view_devices', models.BooleanField(db_column='can_view_devices', help_text='Can view devices in collection', verbose_name='can view devices')),
                ('can_update_devices', models.BooleanField(db_column='can_update_devices', help_text='Can update devices in collection', verbose_name='can update devices')),
                ('can_remove_devices', models.BooleanField(db_column='can_remove_devices', help_text='Can remove devices from collection', verbose_name='can remove devices')),
                ('can_add_schemas', models.BooleanField(db_column='can_add_schemas', help_text='Can add schemas to collection', verbose_name='can add schemas')),
                ('can_remove_schemas', models.BooleanField(db_column='can_remove_schemas', help_text='Can remove schemas from collection', verbose_name='can remove schemas')),
                ('can_add_roles', models.BooleanField(db_column='can_add_roles', help_text='Can add roles to collection', verbose_name='can add roles')),
                ('can_remove_roles', models.BooleanField(db_column='can_remove_roles', help_text='Can remove roles from collection', verbose_name='can remove roles')),
                ('can_add_users', models.BooleanField(db_column='can_add_users', help_text='Can add users to collection', verbose_name='can add users')),
                ('can_update_users', models.BooleanField(db_column='can_update_users', help_text='Can update users in collection', verbose_name='can update users')),
                ('can_remove_users', models.BooleanField(db_column='can_remove_users', help_text='Can remove users from collection', verbose_name='can remove users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('configuration', django.contrib.postgres.fields.jsonb.JSONField(db_column='configuration', help_text='Configuration on device through the sampling event', verbose_name='configuration')),
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to sampling event', null=True, verbose_name='metadata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.CharField(choices=[('annotation_label', 'annotation label'), ('annotation_annotation', 'annotation annotation'), ('annotation_metadata', 'annotation metadata'), ('collection_metadata', 'collection metadata'), ('collection_device_metadata', 'collection device metadata'), ('collection_site_metadata', 'collection site metadata'), ('collection_user_metadata', 'collection user metadata'), ('device_metadata', 'device metadata'), ('entailment_metadata', 'entailment metadata'), ('item_media_info', 'item media info'), ('item_metadata', 'item metadata'), ('licence_metadata', 'licence metadata'), ('model_metadata', 'model metadata'), ('sampling_event_configuration', 'sampling event configuration'), ('sampling_event_metadata', 'sampling event metadata'), ('secondary_item_media_info', 'secondary item media info'), ('site_metadata', 'site metadata'), ('synonym_metadata', 'synonym metadata'), ('term_metadata', 'term metadata'), ('user_metadata', 'user metadata'), ('global', 'global')], db_column='field', help_text='Field to which JSON schema applies', max_length=64, verbose_name='field')),
                ('name', models.CharField(db_column='name', help_text='Name of JSON schema', max_length=30, unique=True, verbose_name='name')),
                ('description', models.TextField(blank=True, db_column='description', help_text='Description of schema', verbose_name='description')),
                ('schema', django.contrib.postgres.fields.jsonb.JSONField(db_column='schema', help_text='JSON object with schema', verbose_name='schema')),
            ],
            options={
                'verbose_name': 'Schema',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_info', django.contrib.postgres.fields.jsonb.JSONField(db_column='media_info', help_text='Media information of secondary item file', verbose_name='media info')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_ref', django.contrib.gis.db.models.fields.PointField(db_column='geo_ref', help_text='Georeference of site as Geometry', srid=4326, verbose_name='geo ref')),
                ('latitude', models.FloatField(db_column='latitude', help_text='Latitude of site', verbose_name='latitude')),
                ('longitude', models.FloatField(db_column='longitude', help_text='Longitude of site', verbose_name='longitude')),
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to site', null=True, verbose_name='metadata')),
                ...
                ('metadata_type', models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for site metadata', limit_choices_to=models.Q(('field__exact', 'site_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
            ],
            options={
                'verbose_name': 'Site',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to the synonym', null=True, verbose_name='metadata')),
                ('metadata_type', models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for synonym metadata', limit_choices_to=models.Q(('field__exact', 'synonym_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to synonym', null=True, verbose_name='metadata')),
                ...
                ('metadata_type', models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for synonym suggestion metadata', limit_choices_to=models.Q(('field__exact', 'synonym_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('term_type', models.CharField(db_column='term_type', help_text='Type of term', max_length=50, verbose_name='term type')),
                ...
                ('metadata_type', models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for term metadata', limit_choices_to=models.Q(('field__exact', 'term_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
            ],
            options={
                'verbose_name': 'Term',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_type', models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for term suggestion metadata', limit_choices_to=models.Q(('field__exact', 'term_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('admin', 'admin'), ('developer', 'developer'), ('curator', 'curator'), ('model', 'model'), ('user', 'user')], db_column='role', help_text='Role of user', max_length=30, verbose_name='role')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='configuration_type', default='free', help_text='Schema for sampling event configuration', limit_choices_to=models.Q(('field__exact', 'sampling_configuration_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='sampling_event_configuration_type', to='database.Schema', to_field='name', verbose_name='configuration type'),
        ),
        migrations.AddField(
            model_name='samplingevent',
            name='device',
            field=models.ForeignKey(db_column='device_id', help_text='Reference to device used on sampling event', on_delete=django.db.models.deletion.PROTECT, to='database.PhysicalDevice', verbose_name='device id'),
        ),
        migrations.AddField(
            model_name='samplingevent',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for sampling event metadata', limit_choices_to=models.Q(('field__exact', 'sampling_event_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='sampling_event_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='samplingevent',
            name='site',
        ...
        migrations.AddField(
            ...
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for device metadata', limit_choices_to=models.Q(('field__exact', 'device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='physicaldevice',
            name='owner',
            field=models.ForeignKey(blank=True, db_column='owner_id', help_text='Owner of device', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='owner'),
        ),
        migrations.AddField(
            model_name='licencetype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema', default='free', help_text='Schema for licence metadata structure', limit_choices_to=models.Q(('field__exact', 'licence_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='licence',
            name='licence_type',
        ...
        migrations.AddField(
            model_name='item',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for item metadata structure', limit_choices_to=models.Q(('field__exact', 'item_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='item',
            name='owner',
        ...
        migrations.AddField(
            ...
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for entailment metadata', limit_choices_to=models.Q(('field__exact', 'entailment_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='entailment',
            name='source',
        ...
        migrations.AddField(
            model_name='device',
            name='brand',
            field=models.ForeignKey(db_column='brand', help_text='Brand of device', limit_choices_to={'term_type': 'brand'}, on_delete=django.db.models.deletion.PROTECT, related_name='device_brand', to='database.DeviceTerm', verbose_name='brand'),
        ),
        migrations.AddField(
            model_name='device',
            name='device_type',
            field=models.ForeignKey(db_column='device_type', help_text='Type of device', limit_choices_to={'term_type': 'device_type'}, on_delete=django.db.models.deletion.PROTECT, related_name='device_type', to='database.DeviceTerm', verbose_name='device type'),
        ),
        migrations.AddField(
            model_name='collectionuser',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for collection user metadata', limit_choices_to=models.Q(('field__exact', 'collection_user_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collectionuser',
            name='role',
        ...
        migrations.AddField(
            ...
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for collection site metadata', limit_choices_to=models.Q(('field__exact', 'collection_site_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collectionsite',
            name='site',
        ...
        migrations.AddField(
            ...
            name='schema',
            field=models.ForeignKey(db_column='schema_id', help_text='Schema to be part of collection', on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='schema id'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectiondevice',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for metadata', limit_choices_to=models.Q(('field__exact', 'collection_device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='collection_device_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata_type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collection',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for collection metadata', limit_choices_to=models.Q(('field__exact', 'collection_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='collection_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collection',
            name='roles',
        ...
        migrations.AddField(
            model_name='collection',
            name='schemas',
            field=models.ManyToManyField(related_name='collection_schemas', through='database.CollectionSchema', to='database.Schema'),
        ),
        migrations.AddField(
            model_name='collection',
            name='sites',
        ...
        migrations.AddField(
            ...
            name='schema',
            field=models.ForeignKey(db_column='schema_id', help_text='JSON schema for annotation type', limit_choices_to=models.Q(('field__exact', 'annotation_annotation'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='schema id'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='annotation',
            name='label_type',
            field=models.ForeignKey(db_column='label_type', default='free', help_text='Schema for label structure', limit_choices_to=models.Q(('field__exact', 'annotation_label'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='annotation_label_type', to='database.Schema', to_field='name', verbose_name='label type'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='last_modified_by',
            field=models.ForeignKey(blank=True, db_column='last_modified_by', help_text='User that modified the annotation last', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='annotation_last_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='last modified by'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for metadata', limit_choices_to=models.Q(('field__exact', 'annotation_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='annotation_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AlterUniqueTogether(
            name='deviceterm',
