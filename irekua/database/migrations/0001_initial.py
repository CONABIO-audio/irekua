# Generated by Django 2.1.7 on 2019-06-05 17:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('created_by', models.ForeignKey(db_column='created_by', help_text='Creator of item', on_delete=django.db.models.deletion.PROTECT, related_name='item_created_by', to=settings.AUTH_USER_MODEL, verbose_name='created by')),
            ],
            options={
                'verbose_name': 'Item',
        ...
        migrations.AlterUniqueTogether(
            name='collectionsite',
            unique_together={('collection', 'internal_id'), ('collection', 'site')},
        ),
        migrations.AlterUniqueTogether(
            name='collectionrole',
