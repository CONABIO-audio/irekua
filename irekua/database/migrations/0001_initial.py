# Generated by Django 2.1.7 on 2019-03-18 16:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('path', models.CharField(blank=True, db_column='path', help_text='Path to resource', max_length=128, null=True, unique=True, verbose_name='path')),
                ('filesize', models.IntegerField(db_column='filesize', help_text='Size of resource in Bytes', verbose_name='file size')),
                ('hash', models.CharField(db_column='hash', help_text='Hash of resource file', max_length=64, unique=True, verbose_name='hash')),
                ('hash_function', models.CharField(choices=[('md5', 'md5'), ('sha244', 'sha244'), ('sha256', 'sha256'), ('sha384', 'sha384'), ('sha512', 'sha512')], db_column='hash_function', help_text='Function used to create hash of file', max_length=16, verbose_name='hash function')),
                ...
                ('collection', models.ForeignKey(db_column='collection_id', help_text='Collection to which item belongs', on_delete=django.db.models.deletion.PROTECT, to='database.Collection', verbose_name='collection')),
            ],
            options={
                'verbose_name': 'Item',
        ...
        migrations.AddField(
            model_name='item',
            name='sampling_event',
            field=models.ForeignKey(blank=True, db_column='sampling_event_id', help_text='Sampling event associated with item', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEvent', verbose_name='sampling event'),
        ),
        migrations.AddField(
            model_name='item',
            name='source',
            field=models.ForeignKey(blank=True, db_column='source_id', help_text='Reference to source of item (parsing function and parent directory)', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Source', verbose_name='source'),
        ),
        migrations.AddField(
            model_name='item',
            name='tags',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, db_column='label_term_types', help_text='Valid term types with which to label this type of events', to='database.TermType', verbose_name='label term types'),
        ),
        migrations.AddField(
