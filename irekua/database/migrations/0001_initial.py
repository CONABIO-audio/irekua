    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restrict_event_types', models.BooleanField(db_column='restrict_event_types', help_text='Flag indicating whether types of events are restricted to registered ones', verbose_name='restrict event types')),
                ('restrict_sampling_event_types', models.BooleanField(db_column='restrict_sampling_event_types', help_text='Flag indicating whether types of sampling events are restricted to registered ones', verbose_name='restrict sampling event types')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='name', help_text='Name of JSON schema', max_length=64, unique=True, validators=[database.models.schemas.not_reserved_names], verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', models.ForeignKey(db_column='metadata_type', help_text='Schema for site metadata', limit_choices_to={'field': 'site_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', models.ForeignKey(db_column='metadata_schema_id', help_text='JSON schema for metadata of terms of type', limit_choices_to={'field': 'term_metadata'}, on_delete=django.db.models.deletion.PROTECT, related_name='term_metadata_type', to='database.Schema', verbose_name='metadata schema')),
                ('synonym_metadata_schema', models.ForeignKey(db_column='synonym_metadata_schema_id', help_text='JSON schema for metadata of synonyms of terms of type', limit_choices_to={'field': 'synonym_metadata'}, on_delete=django.db.models.deletion.PROTECT, related_name='term_synonym_metadata_schema', to='database.Schema', verbose_name='synonym metadata schema')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='metadata_schema', help_text='Schema for metadata for sampling event of this type', limit_choices_to={'field': 'sampling_event_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='samplingeventtype',
            name='site_types',
        ...
        migrations.AddField(
            ...
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', help_text='Schema for licence metadata structure', limit_choices_to={'field': 'licence_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='licence',
            name='licence_type',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='media_info_schema_id', help_text='Reference to JSON Schema to be used with media info of this item type', limit_choices_to={'field': 'item_media_info'}, on_delete=django.db.models.deletion.CASCADE, to='database.Schema', verbose_name='media info schema'),
        ),
        migrations.AddField(
            model_name='item',
            name='item_type',
        ...
        migrations.AddField(
            ...
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', help_text='JSON schema for entailment metadata', limit_choices_to={'field': 'entailment_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='entailmenttype',
            name='source_type',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='configuration_schema_id', default='free', help_text='JSON schema for device configuration', limit_choices_to=models.Q(('field__exact', 'device_configuration'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='device_configuration_schema', to='database.Schema', to_field='name', verbose_name='configuration schema'),
        ),
        migrations.AddField(
            model_name='device',
            name='device_type',
        ...
        migrations.AddField(
            model_name='device',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', help_text='JSON schema for device metadata', limit_choices_to={'field': 'device_metadata'}, on_delete=django.db.models.deletion.PROTECT, related_name='device_metadata_schema', to='database.Schema', verbose_name='metadata schema'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectiontype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', help_text='JSON Schema to be used with collection metadata for collections of this type', limit_choices_to={'field': 'collection_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='roles',
        ...
        migrations.AddField(
            model_name='collectionrole',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type_id', help_text='JSON schema for collection user metadata of role type', limit_choices_to={'field': 'collection_user_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collectionrole',
            name='role',
        ...
        migrations.AddField(
            model_name='collectionitemtype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type', help_text='JSON schema for collection item metadata', limit_choices_to={'field': 'item_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectiondevicetype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type_id', help_text='JSON schema for collection device metadata', limit_choices_to={'field': 'collection_device_metadata'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='metadata type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='schema',
            field=models.ForeignKey(db_column='schema_id', help_text='JSON schema for annotation type', limit_choices_to={'field': 'annotation'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='schema'),
        ),
        migrations.AddField(
            model_name='annotationtool',
            name='configuration_schema',
            field=models.ForeignKey(db_column='configuration_schema_id', help_text='JSON schema for configuration of annotation tool', limit_choices_to={'field': 'annotation_configuration'}, on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='configuration schema'),
        ),
        migrations.AddField(
