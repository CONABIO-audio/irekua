# Generated by Django 2.1.7 on 2019-03-08 04:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', models.ForeignKey(db_column='metadata_schema_id', default='libre', help_text='JSON schema for metadata of terms of type', limit_choices_to=models.Q(('field__exact', 'term_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='term_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata schema')),
                ('synonym_metadata_schema', models.ForeignKey(db_column='synonym_metadata_schema_id', default='libre', help_text='JSON schema for metadata of synonyms of terms of type', limit_choices_to=models.Q(('field__exact', 'synonym_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='term_synonym_metadata_schema', to='database.Schema', to_field='name', verbose_name='synonym metadata schema')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='libre', help_text='Schema for licence metadata structure', limit_choices_to=models.Q(('field__exact', 'licence_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='licence',
            name='licence_type',
        ...
        migrations.AddField(
            ...
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='libre', help_text='JSON schema for entailment metadata', limit_choices_to=models.Q(('field__exact', 'entailment_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='entailmenttype',
            name='source_type',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='configuration_schema_id', default='libre', help_text='JSON schema for device configuration', limit_choices_to=models.Q(('field__exact', 'device_configuration'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='device_configuration_schema', to='database.Schema', to_field='name', verbose_name='configuration schema'),
        ),
        migrations.AddField(
            model_name='device',
            name='device_type',
        ...
        migrations.AddField(
            model_name='device',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='libre', help_text='JSON schema for device metadata', limit_choices_to=models.Q(('field__exact', 'device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='device_metadata_schema', to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectionrole',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type_id', default='libre', help_text='JSON schema for collection user metadata of role type', limit_choices_to=models.Q(('field__exact', 'collection_user_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collectionrole',
            name='role',
        ...
        migrations.AddField(
            model_name='collectiondevicetype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type_id', default='libre', help_text='JSON schema for collection device metadata', limit_choices_to=models.Q(('field__exact', 'collection_device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='schema',
            field=models.ForeignKey(db_column='schema_id', help_text='JSON schema for annotation type', limit_choices_to=models.Q(('field__exact', 'annotation'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', verbose_name='schema'),
        ),
        migrations.AddField(
            model_name='annotationtool',
            name='configuration_schema',
            field=models.ForeignKey(db_column='configuration_schema_id', default='libre', help_text='JSON schema for configuration of annotation tool', limit_choices_to=models.Q(('field__exact', 'annotation_configuration'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='configuration schema'),
        ),
        migrations.AddField(
