    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(db_column='role', help_text='Role of user in collection', on_delete=django.db.models.deletion.PROTECT, to='database.CollectionRoleType', verbose_name='role')),
                ('user', models.ForeignKey(db_column='user_id', help_text='User of collection', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user id')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, db_column='creator_id', help_text='Reference to creator of Meta Collection', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='creator id')),
        ...
        migrations.AddField(
            model_name='device',
            name='metadata_type',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for device metadata', limit_choices_to=models.Q(('field__exact', 'device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='device_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='collection',
            field=models.ForeignKey(db_column='collection_id', help_text='Collection type in which role applies', on_delete=django.db.models.deletion.CASCADE, to='database.CollectionType', verbose_name='collection id'),
        ),
        migrations.AddField(
            model_name='collectionroletype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for collection user metadata of role type', limit_choices_to=models.Q(('field__exact', 'collection_user_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collectionroletype',
            name='role_type',
        ...
        migrations.AddField(
            model_name='collectiondevicetype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for collection device metadata', limit_choices_to=models.Q(('field__exact', 'collection_device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
