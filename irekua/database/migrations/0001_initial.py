# Generated by Django 2.1.7 on 2019-03-24 18:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation_configuration', django.contrib.postgres.fields.jsonb.JSONField(db_column='annotation_configuration', default=database.utils.empty_JSON, help_text='Configuration of annotation tool', verbose_name='annotation configuration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation_types', models.ManyToManyField(blank=True, db_column='annotation_types', help_text='Types of annotations valid for collections of type', to='database.AnnotationType', verbose_name='annotation types')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('filesize', models.IntegerField(blank=True, db_column='filesize', help_text='Size of resource in Bytes', verbose_name='file size')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('creator', models.ForeignKey(blank=True, db_column='creator_id', help_text='Reference to creator of Meta Collection', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='creator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('serial_number', models.CharField(blank=True, db_column='serial_number', help_text='Serial number of device', max_length=128, null=True, unique=True, verbose_name='serial number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(blank=True, db_column='device_id', help_text='Reference to device used on sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.PhysicalDevice', verbose_name='device')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('device_types', models.ManyToManyField(blank=True, db_column='device_types', help_text='Valid device types for this sampling event type', to='database.DeviceType', verbose_name='device types')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hash_function', models.CharField(choices=[('md5', 'md5'), ('sha244', 'sha244'), ('sha256', 'sha256'), ('sha384', 'sha384'), ('sha512', 'sha512')], db_column='hash_function', help_text='Hash function used to generate has of secondary file', max_length=16, verbose_name='hash function')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('creator', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of site', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='creator')),
            ],
            options={
                'verbose_name': 'Site',
        ...
        migrations.AddField(
            ...
            name='site_types',
            field=models.ManyToManyField(blank=True, db_column='site_types', help_text='Valid site types for this sampling event type', to='database.SiteType', verbose_name='site types'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='item',
            name='modified_by',
            field=models.ForeignKey(blank=True, db_column='modified_by', help_text='Last user that modified this item info', null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='modified by'),
        ),
        migrations.AddField(
            model_name='item',
        ...
        migrations.AddField(
            model_name='item',
            name='sampling_event',
            field=models.ForeignKey(db_column='sampling_event_id', help_text='Sampling event associated with item', on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEvent', verbose_name='sampling event'),
        ),
        migrations.AddField(
            model_name='item',
            name='source',
        ...
        migrations.AddField(
            model_name='item',
            name='tags',
            field=models.ManyToManyField(blank=True, db_column='tags', help_text='Tags for item', to='database.Tag', verbose_name='tags'),
        ),
        ...
        migrations.AddField(
            ...
            name='device_types',
            field=models.ManyToManyField(blank=True, db_column='device_types', help_text='Types of devices valid for collections of type', through='database.CollectionDeviceType', to='database.DeviceType', verbose_name='device types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='event_types',
            field=models.ManyToManyField(blank=True, db_column='event_types', help_text='Types of events valid for collections of type', to='database.EventType', verbose_name='event types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='item_types',
            field=models.ManyToManyField(blank=True, db_column='item_types', help_text='Types of items valid for collections of type', through='database.CollectionItemType', to='database.ItemType', verbose_name='item types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='licence_types',
            field=models.ManyToManyField(blank=True, db_column='licence_types', help_text='Types of licences valid for collections of type', to='database.LicenceType', verbose_name='licence types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='roles',
            field=models.ManyToManyField(blank=True, db_column='roles', help_text='Roles valid for collections of type', through='database.CollectionRole', to='database.Role', verbose_name='roles'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='sampling_event_types',
            field=models.ManyToManyField(blank=True, db_column='sampling_event_types', help_text='Types of sampling events valid for collections of type', to='database.SamplingEventType', verbose_name='sampling event types'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='site_types',
            field=models.ManyToManyField(blank=True, db_column='site_types', help_text='Types of sites valid for collections of type', to='database.SiteType', verbose_name='site types'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='device',
            field=models.ForeignKey(db_column='device_id', help_text='Reference to physical device', on_delete=django.db.models.deletion.PROTECT, to='database.PhysicalDevice', verbose_name='device'),
        ),
        migrations.AddField(
