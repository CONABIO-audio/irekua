# Generated by Django 2.1.7 on 2019-04-05 01:54

import database.models.items
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='created_by', help_text='Creator of annotation vote', null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='created by')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_file', models.FileField(blank=True, db_column='item_file', help_text='Upload file associated to file', null=True, upload_to=database.models.items.get_item_path, verbose_name='item file')),
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('created_by', models.ForeignKey(db_column='created_by', help_text='Creator of item', on_delete=django.db.models.deletion.PROTECT, related_name='item_created_by', to=settings.AUTH_USER_MODEL, verbose_name='create by')),
            ],
            options={
                'verbose_name': 'Item',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('created_by', models.ForeignKey(blank=True, db_column='created_by', help_text='Creator of Meta Collection', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='created by')),
                ('items', models.ManyToManyField(db_column='items', help_text='Items belonging to MetaCollection', to='database.Item', verbose_name='items')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(db_column='created_by', help_text='Creator of sampling event', on_delete=django.db.models.deletion.PROTECT, related_name='sampling_event_created_by', to=settings.AUTH_USER_MODEL, verbose_name='create by')),
                ...
                ('modified_by', models.ForeignKey(blank=True, db_column='modified_by', help_text='Last modifier', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sampling_event_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='modified by')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, db_column='created_by', help_text='Creator of sampling event device', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sampling_event_device_created_by', to=settings.AUTH_USER_MODEL, verbose_name='create by')),
                ('licence', models.ForeignKey(blank=True, db_column='licence_id', help_text='Licence for all items in sampling event', null=True, on_delete=django.db.models.deletion.PROTECT, to='database.Licence', verbose_name='licence')),
                ('modified_by', models.ForeignKey(blank=True, db_column='modified_by', help_text='Last modifier', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sampling_event_device_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='modified by')),
        ...
        migrations.CreateModel(
            name='SamplingEventTypeSiteType',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sampling_event_type', models.ForeignKey(db_column='sampling_event_type_id', help_text='Sampling event type in which this site type can be used', on_delete=django.db.models.deletion.CASCADE, to='database.SamplingEventType', verbose_name='sampling event type')),
            ],
            options={
                'verbose_name': 'Sampling Event Type Site Type',
                'verbose_name_plural': 'Sampling Event Type Site Types',
                'ordering': ['sampling_event_type'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('path', models.CharField(db_column='path', help_text='Path to secondary resource', max_length=128, unique=True, verbose_name='path')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of entry creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of site', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='creator')),
            ],
            options={
                'verbose_name': 'Site',
        ...
        migrations.AddField(
            model_name='samplingeventtypesitetype',
            name='site_type',
            field=models.ForeignKey(db_column='site_type_id', help_text='Type of site that can be used in sampling event of the given type', on_delete=django.db.models.deletion.PROTECT, to='database.SiteType', verbose_name='site type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='samplingeventtype',
            name='site_types',
            field=models.ManyToManyField(blank=True, help_text='Valid site types for this sampling event type', through='database.SamplingEventTypeSiteType', to='database.SiteType', verbose_name='site types'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='licence',
            name='signed_by',
            field=models.ForeignKey(blank=True, db_column='signed_by', help_text='User who signed the licence', null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='signed by'),
        ),
        migrations.AddField(
            model_name='item',
            name='item_type',
        ...
        migrations.AddField(
            model_name='item',
            name='modified_by',
            field=models.ForeignKey(blank=True, db_column='modified_by', help_text='Last user that modified this item info', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='item_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='modified by'),
        ),
        migrations.AddField(
            model_name='item',
        ...
        migrations.AddField(
            ...
            name='collection_type',
            field=models.ForeignKey(db_column='collection_type_id', default='generic collection', help_text='Type of collection', on_delete=django.db.models.deletion.PROTECT, to='database.CollectionType', verbose_name='collection type'),
        ),
        migrations.AddField(
            model_name='collection',
            name='institution',
        ...
        migrations.AddField(
            model_name='annotation',
            name='modified_by',
            field=models.ForeignKey(blank=True, db_column='modified_by', editable=False, help_text='User that modified the annotation last', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='annotation_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='modified by'),
        ),
        migrations.AddField(
            model_name='user',
            name='institution',
        ...
        migrations.AlterUniqueTogether(
            name='samplingeventtypesitetype',
            unique_together={('sampling_event_type', 'site_type')},
        ),
        migrations.AlterUniqueTogether(
            name='samplingeventtypedevicetype',
