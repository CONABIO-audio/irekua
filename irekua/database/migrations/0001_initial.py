    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotation_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='annotation_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for annotation info', validators=[database.utils.validate_JSON_schema], verbose_name='annotation schema')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_info_schema', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='media_info_schema', default=database.utils.simple_JSON_schema, help_text='JSON Schema for item type media info', validators=[database.utils.validate_JSON_schema], verbose_name='media info schema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('configuration', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='configuration', default=database.utils.empty_JSON, help_text='Configuration for this upload session', null=True, verbose_name='configuration')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='uploadsession_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
                ('modified_by', models.ForeignKey(blank=True, db_column='modified_by', editable=False, help_text='User who made modifications last', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uploadsession_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='modified by')),
                ('sampling_event_device', models.ForeignKey(db_column='sampling_event_device_id', help_text='Sampling event device used to create item', on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEventDevice', verbose_name='sampling event device')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, db_column='created_on', help_text='Date of creation', verbose_name='created on')),
                ('modified_on', models.DateTimeField(auto_now=True, db_column='modified_on', help_text='Date of last modification', verbose_name='modified on')),
                ('error', models.CharField(blank=True, db_column='error', help_text='Type of error (if apply)', max_length=64, verbose_name='error')),
                ('created_by', models.ForeignKey(blank=True, db_column='creator_id', help_text='Creator of object', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='uploadevent_created_by', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
                ('item', models.ForeignKey(blank=True, db_column='item_id', help_text='Created item (if apply)', on_delete=django.db.models.deletion.PROTECT, to='database.Item', verbose_name='item')),
                ('modified_by', models.ForeignKey(blank=True, db_column='modified_by', editable=False, help_text='User who made modifications last', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uploadevent_modified_by', to=settings.AUTH_USER_MODEL, verbose_name='modified by')),
                ('upload_session', models.ForeignKey(db_column='upload_session_id', help_text='Upload session', on_delete=django.db.models.deletion.PROTECT, to='database.UploadSession', verbose_name='upload session')),
            ],
            options={
                'verbose_name': 'Upload Session',
                'verbose_name_plural': 'Upload Sessions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term_type', models.ForeignKey(db_column='term_type', help_text='Type of term', on_delete=django.db.models.deletion.CASCADE, to='database.TermType', verbose_name='term type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, db_column='description', help_text='Description of term', verbose_name='description')),
                ('metadata', django.contrib.postgres.fields.jsonb.JSONField(blank=True, db_column='metadata', default=database.utils.empty_JSON, help_text='Metadata associated to term', null=True, verbose_name='metadata')),
                ('term_type', models.ForeignKey(db_column='term_type', help_text='Type of term', limit_choices_to={'is_categorical': True}, on_delete=django.db.models.deletion.CASCADE, to='database.TermType', verbose_name='term type')),
            ],
            options={
                'verbose_name': 'Term',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(db_column='source_id', on_delete=django.db.models.deletion.CASCADE, to='database.Term', verbose_name='')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(db_column='source_id', help_text='Reference to the source of synonym', on_delete=django.db.models.deletion.CASCADE, related_name='synonym_source', to='database.Term', verbose_name='source')),
                ('target', models.ForeignKey(db_column='target_id', help_text='Reference to the target of the synonym', on_delete=django.db.models.deletion.CASCADE, related_name='synonym_target', to='database.Term', verbose_name='target')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(db_column='device_id', help_text='Brand and model of device', on_delete=django.db.models.deletion.PROTECT, to='database.Device', verbose_name='device')),
        ...
        migrations.AddField(
            model_name='itemtype',
            name='mime_types',
            field=models.ManyToManyField(blank=True, db_column='mime_types', help_text='Mime types of files for this item type', to='database.MimeType', verbose_name='mime types'),
        ),
        migrations.AddField(
            model_name='item',
            name='item_type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(db_column='source_id', help_text='Source of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_source', to='database.Term', verbose_name='source')),
                ('target', models.ForeignKey(db_column='target_id', help_text='Target of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_target', to='database.Term', verbose_name='target')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(db_column='role_id', help_text='Role of user in collection', on_delete=django.db.models.deletion.PROTECT, to='database.Role', verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_types', models.ManyToManyField(blank=True, help_text='Types of devices valid for collections of type', through='database.CollectionDeviceType', to='database.DeviceType', verbose_name='device types')),
                ('event_types', models.ManyToManyField(blank=True, help_text='Types of events valid for collections of type', to='database.EventType', verbose_name='event types')),
                ('item_types', models.ManyToManyField(blank=True, help_text='Types of items valid for collections of type', through='database.CollectionItemType', to='database.ItemType', verbose_name='item types')),
                ('licence_types', models.ManyToManyField(blank=True, help_text='Types of licences valid for collections of type', to='database.LicenceType', verbose_name='licence types')),
                ('roles', models.ManyToManyField(blank=True, help_text='Roles valid for collections of type', through='database.CollectionRole', to='database.Role', verbose_name='roles')),
                ('sampling_event_types', models.ManyToManyField(blank=True, help_text='Types of sampling events valid for collections of type', to='database.SamplingEventType', verbose_name='sampling event types')),
                ('site_types', models.ManyToManyField(blank=True, help_text='Types of sites valid for collections of type', to='database.SiteType', verbose_name='site types')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='annotation',
            name='labels',
            field=models.ManyToManyField(blank=True, db_column='labels', help_text='Labels associated with annotation', to='database.Term', verbose_name='labels'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='modified_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_type', models.ForeignKey(db_column='source_type_id', help_text='Term type of source of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_source_type', to='database.TermType', verbose_name='source type')),
                ('target_type', models.ForeignKey(db_column='target_type_id', help_text='Term type of target of entailment', on_delete=django.db.models.deletion.CASCADE, related_name='entailment_target_type', to='database.TermType', verbose_name='target type')),
            ],
            options={
