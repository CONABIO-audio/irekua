...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_column='name', help_text='Name of annotation tool', max_length=64, unique=True, verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', models.ForeignKey(db_column='metadata_type', default='free', help_text='Schema for site metadata', limit_choices_to=models.Q(('field__exact', 'site_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_schema', models.ForeignKey(db_column='metadata_schema_id', default='free', help_text='JSON schema for metadata of terms of type', limit_choices_to=models.Q(('field__exact', 'term_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='term_metadata_type', to='database.Schema', to_field='name', verbose_name='metadata schema')),
                ('synonym_metadata_schema', models.ForeignKey(db_column='synonym_metadata_schema_id', default='free', help_text='JSON schema for metadata of synonyms of terms of type', limit_choices_to=models.Q(('field__exact', 'synonym_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='term_synonym_metadata_schema', to='database.Schema', to_field='name', verbose_name='synonym metadata schema')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='site',
            name='site_type',
            field=models.ForeignKey(db_column='site_type', default='generic site', help_text='Type of site', on_delete=django.db.models.deletion.PROTECT, to='database.SiteType', to_field='name', verbose_name='site type'),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='sampling_event_type', default='generic sampling event', help_text='Type of sampling event', on_delete=django.db.models.deletion.PROTECT, to='database.SamplingEventType', to_field='name', verbose_name='sampling event type'),
        ),
        migrations.AddField(
            model_name='samplingevent',
            name='site',
        ...
        migrations.AddField(
            ...
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='free', help_text='Schema for licence metadata structure', limit_choices_to=models.Q(('field__exact', 'licence_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='licence',
            name='licence_type',
        ...
        migrations.AddField(
            ...
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='free', help_text='JSON schema for entailment metadata', limit_choices_to=models.Q(('field__exact', 'entailment_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='entailment',
            name='source',
        ...
        migrations.AddField(
            model_name='device',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='free', help_text='JSON schema for device metadata', limit_choices_to=models.Q(('field__exact', 'device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, related_name='device_metadata_schema', to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectiontype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_schema_id', default='free', help_text='JSON Schema to be used with collection metadata for collections of this type', limit_choices_to=models.Q(('field__exact', 'collection_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata schema'),
        ),
        migrations.AddField(
            model_name='collectiontype',
            name='roles',
        ...
        migrations.AddField(
            model_name='collectionrole',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type_id', default='free', help_text='JSON schema for collection user metadata of role type', limit_choices_to=models.Q(('field__exact', 'collection_user_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
            model_name='collectionrole',
            name='role',
        ...
        migrations.AddField(
            model_name='collectionitemtype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type', default='free', help_text='JSON schema for collection item metadata', limit_choices_to=models.Q(('field__exact', 'item_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='collectiondevicetype',
            name='metadata_schema',
            field=models.ForeignKey(db_column='metadata_type_id', default='free', help_text='JSON schema for collection device metadata', limit_choices_to=models.Q(('field__exact', 'collection_device_metadata'), ('field__exact', 'global'), _connector='OR'), on_delete=django.db.models.deletion.PROTECT, to='database.Schema', to_field='name', verbose_name='metadata type'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='collection_type',
            field=models.ForeignKey(db_column='collection_type_id', default='generic collection', help_text='Type of collection', on_delete=django.db.models.deletion.PROTECT, to='database.CollectionType', to_field='name', verbose_name='collection type'),
        ),
        migrations.AddField(
            model_name='collection',
            name='devices',
