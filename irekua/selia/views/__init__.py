...
from .user.data_collections import user_collections
...
from .data_collections.home import collection_home
from .data_collections.devices import collection_devices
from .data_collections.items import collection_items
