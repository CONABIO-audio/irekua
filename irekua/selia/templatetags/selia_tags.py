...
@register.inclusion_tag('selia/components/list_icon.html')
def list_icon(item, size='5em'):
    return {'item': item, 'size':size}


@register.inclusion_tag('selia/components/detail_icon.html')
...
def listattribute(parser, token):
    ...
    parser.delete_first_token()
    return GenericNode(
        template_name='selia/components/list_attribute.html',
        header=header,
        content=content)
...
def listtitle(parser, token):
    ...
    return GenericNode(
        template_name='selia/components/list_item_title.html',
        title=title,
        image=image,
...
def listsummary(parser, token):
    ...
    return GenericNode(
            template_name='selia/components/list_item_summary.html',
            title=title,
            count=count,
            buttons=buttons)
...
def detailitem(parser, token):
    ...
    parser.delete_first_token()
    return GenericNode(
        template_name='selia/components/detail_item.html',
        header=header,
        content=content)
...
def detailtitle(parser, token):
    ...
    return GenericNode(
        template_name='selia/components/detail_title.html',
        title=title,
        image=image,
        description=description)
...
def detailsection(parser, token):
    ...
    parser.delete_first_token()
    return GenericNode(
        template_name='selia/components/detail_section.html',
        content=content)
